...
export function launchSkillsPreviewDetail(presetMode: boolean): string {
  ...
  return "Skills follow the auto-resolved runtime profile for this launch selection. Library skills are enabled by default unless that profile has opt-outs.";
}