...
func (server *Server) routes() {
	...
	server.mux.HandleFunc("GET /api/sessions/{id}/transcript/children/{child_id}", server.handleSessionChildHistory)
	server.mux.HandleFunc("GET /api/sessions/{id}/transcript/children/{child_id}/items/{cursor}", server.handleSessionChildHistory)
	server.mux.HandleFunc("GET /api/sessions/{id}/transcript/children/{child_id}/changes/{change_cursor}", server.handleSessionChildHistory)
	...
	server.mux.HandleFunc("GET /api/projects/{id}/tasks/{task_id}/transcript/children/{child_id}", server.handleTaskChildHistory)
	server.mux.HandleFunc("GET /api/projects/{id}/tasks/{task_id}/transcript/children/{child_id}/items/{cursor}", server.handleTaskChildHistory)
	server.mux.HandleFunc("GET /api/projects/{id}/tasks/{task_id}/transcript/children/{child_id}/changes/{change_cursor}", server.handleTaskChildHistory)
