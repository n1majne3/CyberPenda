...
var nodeSchemas = map[NodeType]map[string]propertyRule{
	...
	NodeTypeEvidenceArtifact:     {"artifact_type": {required: true, enums: enum("http_exchange", "screenshot", "terminal_capture", "log", "pcap", "file", "binary", "source_code", "structured_data", "report", "other")}, "media_type": {}, "source_path": {}, "managed_path": {required: true}, "sha256": {}, "size_bytes": {}, "summary": {required: true}, "status": {enums: enum("available", "missing", "superseded")}, "captured_at": {}, "migrated_attach_to_type": {enums: enum("fact", "finding")}, "migrated_attach_to_key": {}},
