...
func TestCreateStoresUserRuntimeProfileWithoutKind(t *testing.T) {
	...
	if fetched.Name != "Manual Preset" || fetched.Provider != runtimeprofile.ProviderCodex {
		t.Fatalf("fetched Runtime Profile = %#v", fetched)
	}
}
